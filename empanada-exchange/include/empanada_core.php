<?PHP
namespace Empanada_core;

function get_ars_value()
{
	global $wpdb;
	// $table_name = "PREFIX" + "empanada_exchange" (Mostly wp_empanada_exchange).
...
/*  //Source 1 = fixer.io
	if ($source == 1)
	{
		$data = json_decode(wp_remote_get($fullurl), true);
	...
	/*else*/if ($source == 2) 
	{
		...
		//The index 0 should be "Official dollar" without taxes in Argentina.
